...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- <body class="bg-cover bg-center" style="background-image: url('/images/dark-bg.jpg');"> -->
        ...
        <div class="h-screen flex justify-center items-center relative overflow-hidden before:absolute before:top-0 before:left-1/2 before:bg-no-repeat before:bg-top before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 ">
            <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-20">
                ...
                <a class="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-xs text-gray-600 p-2 px-3 rounded-full transition hover:border-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:hover:border-gray-600 dark:text-gray-400" href="#">
                    ...
                    <span class="border-l border-gray-200 text-blue-600 pl-2 dark:text-blue-500">test2</span>
                ...
                <p class="text-lg text-gray-600 dark:text-gray-400">エンジニアの生産性を可視化する。</p>
                </div>
